...
global.sudo = process.env.SUDO || '94786728789'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'ɪ𝗧s 𝐌ᴇ 𝐒ᴀ𝖧α𝗡' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Vajira' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? VAJIRA;;;PatientSchiller : process.env.SESSION_ID,
